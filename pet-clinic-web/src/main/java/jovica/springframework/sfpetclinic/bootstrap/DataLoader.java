...
import jovica.springframework.sfpetclinic.model.*;
...
import jovica.springframework.sfpetclinic.services.SpecialtyService;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Specialty radology = new Specialty();
        radology.setDescription("Radiology");
        Specialty savedRadiology = specialtyService.save(radology);
